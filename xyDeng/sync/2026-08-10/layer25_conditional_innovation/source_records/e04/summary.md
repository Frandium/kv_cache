...
Primary Anchor: [A15_08 Target-Conditioned Layer Innovation](../anchor/anchor.md)
Frozen Protocol: [A15_08_E04_v1](protocol.md), SHA-256 `5072d76d9a44877e270b910424ea255ffee347dc17097640c88e20200d82a27d`
Detailed record: source-repository canonical ledger; intentionally excluded from this minimal package because it links raw arrays, logs, and per-record tables.
Result status / eligibility: `ELIGIBLE` after S0--S6; the source-repository record-completeness audit confirms 59 complete artifacts across all 39 required families.
...
An independent post-run cold-read audit retained in the source repository
...
| --- | ---: | --- | --- | --- |
| H2: lower bound of $G_{true}>0$ | $0.767207\ [0.751296,0.785146]$ | 128 fresh complex episodes | Pass | [metrics](../../tables/e04_confirmation_metrics.csv); complex arrays remain source-repository only |
| H2: lower bound of $G_{state}>0$ | $0.754508\ [0.738226,0.773069]$ | same-dimensional state comparison | Pass | [metrics](../../tables/e04_confirmation_metrics.csv) |
| H2: lower bound of $T_{cap}>0$ | $0.766839\ [0.750643,0.784307]$ | 64/64 balanced banks valid, distinct, zero-MI, and unreused | **H2 Pass** | [metrics](../../tables/e04_confirmation_metrics.csv); bank audit retained in the source repository |
| H1': lower bound of $D_{80}>0$ | $-0.358713\ [-0.369760,-0.348675]$ | evaluated only after H2 Pass | **H1' Fail** because the upper bound is non-positive | [metrics](../../tables/e04_confirmation_metrics.csv); complex arrays remain source-repository only |
| H1': lower bound of $T_{random}>0$ | $0.034265\ [0.024293,0.040979]$ | 64 frozen equal-rank random controls | Pass, but cannot rescue $D_{80}$ | [metrics](../../tables/e04_confirmation_metrics.csv) |
| H1': lower bound of $T_{perm}>0$ | $0.234832\ [0.224277,0.244831]$ | 64 frozen TRAIN-label-permutation controls | Pass, but cannot rescue $D_{80}$ | [metrics](../../tables/e04_confirmation_metrics.csv) |
...
The figure uses [confirmation_metrics.csv](../../tables/e04_confirmation_metrics.csv)
and the source-repository `complex_confirmation_arrays.npz` raw array, which is
intentionally excluded from this minimal package.
...
gain. The complete figure contract is retained in the source repository.
